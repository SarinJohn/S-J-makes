			...
			<section id="one" class="wrapper style1 align-center" style="height: 600px">
				<div class="container">
					...
					<div class="row 200%">
						...
						<section class="4u 12u$(small)">
							<a href="productMenu.php?n=<?php echo $_SESSION['Category']; ?>" name="catSearch"><img src="search.png"></a>
							<p>Search according to your needs</p>
						</section>
						<section class="4u$ 12u$(small)">
							<a href="productmenu.php?n=<?php echo $_SESSION['Category']; ?>"><img src="product.png"></a>
							<p>Our products</p>
						</section>
					</div>
				</div>
