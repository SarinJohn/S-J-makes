					...
					<form method="post" action="#">
						<div class="row uniform 50%">
							...
							<div class="4u 12u$(small)">
										...
										<label for="priority-low"><h2 style="font-size: 120%;">Agriculture</h2></label>
									</div>
									<div class="4u 12u$(small)">
										<input type="radio" id="priority-normal" name="priority">
										<label for="priority-normal"><h2 style="font-size: 120%;">Animal Husbandry</h2></label>
									</div>
									<div class="4u$ 12u$(small)">
										<input type="radio" id="priority-high" name="priority">
										<label for="priority-high"><h2 style="font-size: 120%;"> Farm Produce</h2></label>
									</div>
