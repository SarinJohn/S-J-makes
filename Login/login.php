<?php
    ...
    if($user == $admin_config['admin_user'] && $pass == $admin_config['admin_password']) {
        ...
        // $_SESSION['picId'] = 0;
        $_SESSION['Addr'] = $admin_config['admin_address'];
        $_SESSION['Mobile'] = $admin_config['admin_phone'];
        $_SESSION['Email'] = $admin_config['admin_email'];
        $_SESSION['Rating'] = 0;
        $_SESSION['Name'] = "Admin";
        $_SESSION['Category'] = 1;
